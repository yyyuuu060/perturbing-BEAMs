...
def MINE_plot_topomap(data, pos, vmin=None, vmax=None, cmap=None, sensors=True,
                 res=23, axes=None, names=None, show_names=False, mask=None,
                 mask_params=None, outlines='head',
                 contours=5, image_interp='bilinear', show=True,
                 onselect=None, extrapolate=_EXTRAPOLATE_DEFAULT,
                 sphere=None, border=_BORDER_DEFAULT,
                 ch_type='eeg'):
    sphere = _check_sphere(sphere)
    return E_plot_topomap(data, pos, vmin, vmax, cmap, sensors, res, axes,
...
def plot_topomap(data, pos, vmin=None, vmax=None, cmap=None, sensors=True,
                 res=22, axes=None, names=None, show_names=False, mask=None,
                 mask_params=None, outlines='head',
    ...
    """
    sphere = _check_sphere(sphere)
    Zi = _plot_topomap(data, pos, vmin, vmax, cmap, sensors, res, axes,
                         names, show_names, mask, mask_params, outlines,
                         contours, image_interp, show,
                         onselect, extrapolate, sphere=sphere, border=border,
                         ch_type=ch_type)
...
def _plot_topomap(data, pos, vmin=None, vmax=None, cmap=None, sensors=True,
    ...
    # np.savetxt('YYI.csv', YYI, delimiter=",")
    # np.savetxt('XXI.csv', XXI, delimiter=",")
    ...
    return Zi
def E_plot_topomap(data, pos, vmin=None, vmax=None, cmap=None, sensors=True,
                  res=64, axes=None, names=None, show_names=False, mask=None,
                  mask_params=None, outlines='head',
                  contours=6, image_interp='bilinear', show=True,
                  onselect=None, extrapolate=_EXTRAPOLATE_DEFAULT, sphere=None,
